					...
					<nav class="phantrang mb-3  wow  fadeInUp">
						<ul class="pagination">
							<?php
								...
								// dung explore de tach
								$uri=explode('/', $uri); // => tro thanh array
							...
							<?php 
								if($tranghientai>1)
								{
									?>
									<li class="pre">
										<a href="<?= base_url()."Tintuc/page/" ?><?= $tranghientai -1; ?>" aria-label="Previous">
							...
							<?php 
								for($i=0; $i<$sotrang; $i++)
								{
									...
									<?php 
										...
										{
											?>
											<li><a href="<?= base_url()."Tintuc/page/"?><?= $i+1; ?>"><?= $i+1; ?></a></li>
											<?php
										}
									?>
