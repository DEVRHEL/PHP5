		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					...
					?>
					<form class="contact-form" method="post" action="<?= base_url()?>Contact/update">
						<div class="row">
							<div class="col-lg-6">
								Host Name<input type="text" name="host" value="<?= $data['host']?>" placeholder="<?= $data['host']?>">
							</div>
							<div class="col-lg-6">
								Username<input type="text" name="username" value="<?= $data['username']?>" placeholder="<?= $data['username']?>">
							</div>
							<div class="col-lg-6">
								Password<input type="text" name="password" value="<?= $data['password']?>" placeholder="<?= $data['password']?>">
							</div>
							<div class="col-lg-6">
								SMTP Secure<input type="text" name="smtpsecure" value="<?= $data['smtpsecure']?>" placeholder="<?= $data['smtpsecure']?>">
							</div>
							<div class="col-lg-6">
								Port<input type="text" name="port" value="<?= $data['port']?>" placeholder="<?= $data['port']?>">
							</div>
							<div class="col-lg-6">
								Address From<input type="text" name="addressfrom" value="<?= $data['addressfrom']?>" placeholder="<?= $data['addressfrom']?>">
							</div>
							<div class="col-lg-6">
								Name From<input type="text" name="namefrom" value="<?= $data['namefrom']?>" placeholder="<?= $data['namefrom']?>">
							</div>
							<div class="col-lg-4">
							</div>
							<div class="col-lg-12">
